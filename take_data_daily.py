        ...
        if  len(frame)>30 and len(framew)>30 and frame['ADX'].iloc[-1]>=adx_value and frame['RISK'].iloc[-1]<=riskvalue:
            ...
            or framew['Close'].iloc[-1]>framew['sup2'].iloc[-1] or framew['Trend MACD'].iloc[-1]=='Buy'):
                ...
                if option2 == 'EMASUPER':
                    ...
                    or frame['EMA50_cross'].iloc[-1]=='Buy2' or frame['EMA20_cross'].iloc[-1]=='Buy2') and frame['Dec_EMA20'].iloc[-1]>frame['Dec_EMA50'].iloc[-1]):
                            sira +=1
                            expander()
                if option2 == 'Consolidating':
                    if frame['Consolidating2'].iloc[-1]=='Yes' and frame['Consolidating3'].iloc[-1]=='Yes'\
                    and frame['Dec_EMA20'].iloc[-1]>frame['Dec_EMA50'].iloc[-1] and frame['Close'].iloc[-1]>frame['sup2'].iloc[-1]>frame['sup4'].iloc[-1]>frame['sup6'].iloc[-1]:
