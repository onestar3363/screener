        ...
        if  len(frame)>30 and len(framew)>30 and frame['ADX'].iloc[-1]>=adx_value and frame['RISK'].iloc[-1]<=riskvalue:
            ...
            #and (framew['Close'].iloc[-1]>framew['sup4'].iloc[-1] or framew['Close'].iloc[-1]>framew['sup6'].iloc[-1]):
                if option2 == 'EMASUPER':
                    ...
                    or ((frame['Consolidating2'].iloc[-1]=='Yes' or frame['Consolidating3'].iloc[-1]=='Yes')\
                    and (frame['Dec_EMA50'].iloc[-1]=='Sell' and frame['Dec_EMA20'].iloc[-1]=='Buy')))\
                ...
                if option2 == 'Consolidating2':
                    ...
                    and (frame['Dec_EMA20'].iloc[-1]=='Buy' and frame['Dec_EMA50'].iloc[-1]=='Buy' and frame['Close'].iloc[-1]>frame['sup6'].iloc[-1] and frame['Close'].iloc[-1]>frame['sup2'].iloc[-1]):
                    #and (frame['Close'].iloc[-1]<frame['sup6'].iloc[-1] or frame['Close'].iloc[-1]<frame['sup4'].iloc[-1] or frame['Close'].iloc[-1]<frame['sup4'].iloc[-1])
                            sira +=1
                            expander()                            
