            ...
            and framew['Dec_EMA50'].iloc[-1]=='Sell' and framew['sup'].iloc[-1]==-1:
                ...
                if option2 == 'MACD':
                    if frame['Dec_MACD'].iloc[-1]=='Sell' and frame['MACD'].iloc[-1]>=0:
                            ...
                            expander()
                if option2 == 'Consolidating':
                    if (frame['Consolidating'].iloc[-1]=='Yes' or frame['Consolidating2'].iloc[-1]=='Yes') and frame['MACD_diff'].iloc[-1]<0 and frame['Dec_EMA20'].iloc[-1]=='Sell' and frame['MACD'].iloc[-1]>=0 :
                            sira +=1
                            expander()          
                if option2 == 'Supertrend':
