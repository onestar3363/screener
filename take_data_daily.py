...
for name, frame,framew in zip(names,framelist,framelistw): 
    try:
        if  len(frame)>30 and len(framew)>30 and frame['ADX'].iloc[-1]>=adx_value and frame['RISK'].iloc[-1]<=riskvalue :
            ...
            if option1 == 'Buy' and framew['Close'].iloc[-1]>framew['sup6'].iloc[-1] and (framew['Dec_EMA50'].iloc[-1]=='Buy' or framew['Dec_EMA20'].iloc[-1]=='Buy')\
            ...
            if option1 == 'Sell' and framew['Close'].iloc[-1]<framew['sup6'].iloc[-1]\
            and (framew['Dec_EMA50'].iloc[-1]=='Sell' or framew['Dec_EMA20'].iloc[-1]=='Sell') and framew['Close'].iloc[-1]<framew['sup6'].iloc[-1]\
