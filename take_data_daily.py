        ...
        #and frame['RISK'].iloc[-1]<=riskvalue:
            ...
            #framew['Dec_EMA20'].iloc[-1]=='Buy' or framew['Dec_EMA50'].iloc[-1]=='Buy'
                ...
                if option2 == 'Consolidating':
                    ...
                    and frame['EMA20'].iloc[-1]>frame['EMA50'].iloc[-1] and frame['Dec_EMA200'].iloc[-1]=='Buy' and frame['Dec_EMA50'].iloc[-1]=='Buy' :
            ...
            #and (framew['Close'].iloc[-1]<framew['sup4'].iloc[-1] or framew['Close'].iloc[-1]<framew['sup6'].iloc[-1])
                if option2 == 'EMASUPER':
                   if (frame['Decision Super2'].iloc[-1]=='Sell' or frame['EMA50_cross'].iloc[-1]=='Sell' or frame['Decision Super'].iloc[-1]=='Sell' )\
                ...
                if option2 == 'Consolidating':
                    if (frame['Consolidating2'].iloc[-1]=='Yes' and frame['Consolidating3'].iloc[-1]=='Yes')\
                    and (frame['EMA20'].iloc[-1]<frame['EMA50'].iloc[-1] and frame['Dec_EMA200'].iloc[-1]=='Sell' and frame['Dec_EMA50'].iloc[-1]=='Sell' ):
                    #and (frame['Close'].iloc[-1]<frame['sup2'].iloc[-1]<frame['sup4'].iloc[-1]<frame['sup6'].iloc[-1])\
                            sira +=1
                            expander()                       
