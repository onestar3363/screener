        ...
        if  len(frame)>30 and len(framew)>30 and frame['ADX'].iloc[-1]>=adx_value and frame['RISK'].iloc[-1]<=riskvalue :
            ...
            or framew['MACD_diff'].iloc[-1]>0): 
                if option2 == 'EMASUPER':  
                    ...
                    and (frame['MACD_diff'].iloc[-1]>0) and frame['Close'].iloc[-1]>=frame['EMA20'].iloc[-1]): #and frame['EMA20'].iloc[-1]>frame['EMA50'].iloc[-1]):                        
                            sira +=1
                            expander()
                if option2 == 'EMA200':  
            ...
            or framew['MACD_diff'].iloc[-1]<0):
                if option2 == 'EMASUPER':  
                    ...
                    and (frame['MACD_diff'].iloc[-1]<0 and frame['Close'].iloc[-1]<=frame['EMA20'].iloc[-1]):                            
                            sira +=1
                            expander()
                if option2 == 'EMA200':  
