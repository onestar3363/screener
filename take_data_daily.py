...
def get_figures(frame):
    ...
    fig.add_vline(x=frame['Date'].tail(r), y=0.8, line_width=3, line_dash="dash", line_color="green",row=3, col=1)
    #fig.add_hline(y=20, line_width=3, line_dash="dash", line_color="green"), row=3, col=1)
    #fig.add_trace(go.Scatter(x=frame['Date'].tail(r),
    #     y=80,
