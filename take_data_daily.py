    ...
    try:
        if  len(frame)>30 and len(framew)>30 and frame['ADX'].iloc[-1]>=adx_value and frame['ADX'].iloc[-1]<=adx_value2 and frame['RISK'].iloc[-1]<=riskvalue:
            ...
            #framew['Dec_EMA20'].iloc[-1]=='Buy' or framew['Dec_EMA50'].iloc[-1]=='Buy'
                ...
                if option2 == 'EMASUPER':
                    if (frame['Decision Super2'].iloc[-1]=='Buy' or frame['Decision Super2'].iloc[-1]=='Buy2'\
                    or frame['Decision Super3'].iloc[-1]=='Buy' or frame['Decision Super3'].iloc[-1]=='Buy2'\
                    or frame['EMA50_cross'].iloc[-1]=='Buy' or frame['EMA50_cross'].iloc[-1]=='Buy2')\
