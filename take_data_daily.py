...
def expander(cond):
       with st.expander(cond+' '+str(sira) +') '+ name+'/'+' RISK= '+str(frame['RISK'].iloc[-1].round(2))+'/ %ATR='+str(frame['ATR%'].iloc[-1].round(2)+'/ %ATR='+str(frame['ATR%'].iloc[-1].round(2))):
...
for name, frame,framew in zip(names,framelist,framelistw): 
    try:
        ...
        #and frame['RISK'].iloc[-1]<=riskvalue:
            ...
            if option1 == 'Buy' and  (framew['Trend MACD'].iloc[-1]=='Buy' or framew['Dec_MACD'].iloc[-1]=='Buy')\
            ...
            #or framew['Close'].iloc[-1]>framew['sup2'].iloc[-1] or framew['Close'].iloc[-1]>framew['sup4'].iloc[-1])):
                ...
                if option2 == 'EMASUPER':
                   ...
                   #         sira +=1
                   #         expander('breakout')                          
                   if (frame['Decision Super2'].iloc[-h1]=='Buy2' or frame['Decision Super3'].iloc[-h1]=='Buy2'\
                    ...
                    #and frame['Close'].iloc[-h1]>frame['EMA20'].iloc[-h1]:
            ...
            if option1 == 'Sell' and (framew['Trend MACD'].iloc[-1]=='Sell' or framew['Dec_MACD'].iloc[-1]=='Sell')\
            and (framew['Consolidating2'].iloc[-h1]=='Yes' and framew['Consolidating3'].iloc[-h1]=='Yes'):
