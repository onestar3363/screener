...
for name, frame,framew in zip(names,framelist,framelistw): 
    try:
        ...
        #and frame['RISK'].iloc[-1]<=riskvalue:
            ...
            if option1 == 'Buy' and (framew['Close'].iloc[-1]>framew['sup2'].iloc[-1] or framew['Close'].iloc[-1]>framew['sup4'].iloc[-1]):
           
                if option2 == 'EMASUPER':
                   #if (frame['EMA50_cross'].iloc[-h1]=='Buy' or frame['Decision Super2'].iloc[-h1]=='Buy')\
                   ...
                   #         sira +=1
                   #         expander('breakout')
                   if (framew['EMA50_cross'].iloc[-h1]=='Buy' or framew['Decision Super2'].iloc[-h1]=='Buy' or  framew['Decision Super'].iloc[-h1]=='Buy'\
                    ...
                    and frame['Close'].iloc[-h1]>frame['EMA50'].iloc[-h1]\
            ...
            if option1 == 'Sell' and (framew['Close'].iloc[-1]<framew['sup2'].iloc[-1] or framew['Close'].iloc[-1]<framew['sup4'].iloc[-1]):
            ...
            #(framew['Trend MACD'].iloc[-1]=='Sell' or framew['Dec_EMA50'].iloc[-1]=='Sell'):
                if option2 == 'EMASUPER':
                   ...
                   #and (frame['Close'].iloc[-h]<frame['sup4'].iloc[-h] or frame['Close'].iloc[-h]<frame['sup6'].iloc[-h])\
                            sira +=1
                            expander('breakout')
                   elif (frame['Decision Super2'].iloc[-h1]=='Sell2' or frame['EMA50_cross'].iloc[-h1]=='Sell2' or frame['Decision Super'].iloc[-h1]=='Sell2'\
                    or frame['EMA20_cross'].iloc[-h1]=='Sell2')\
                    and frame['Dec_EMA50'].iloc[-h1]=='Sell':
                   #and (frame['Close'].iloc[-h]<frame['sup4'].iloc[-h] or frame['Close'].iloc[-h]<frame['sup6'].iloc[-h])\
                            sira +=1
                            expander('pullback')         
