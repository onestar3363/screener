...
for name, frame,framew in zip(names,framelist,framelistw): 
    try:
        ...
        #and frame['RISK'].iloc[-1]<=riskvalue:
            ...
            if option1 == 'Buy' and framew['Dec_EMA50'].iloc[-h]=='Buy':
            ...
            #or framew['Trend MACD'].iloc[-1]=='Buy'
                ...
                if option2 == 'EMASUPER':
                    ...
                    #and frame['EMA20'].iloc[-h]<frame['EMA50'].iloc[-h]\
                            sira +=1
                            expander('emasuper')
                    elif (frame['Decision Super2'].iloc[-h]=='Buy2'\
                    or frame['EMA50_cross'].iloc[-h]=='Buy2' or frame['Decision Super'].iloc[-h]=='Buy2')\
                    and frame['Dec_EMA50'].iloc[-h]=='Buy':
                    #and (frame['Close'].iloc[-h]>frame['sup6'].iloc[-h] or frame['Close'].iloc[-h]>frame['sup4'].iloc[-h]):
                    #and frame['EMA20'].iloc[-h]<frame['EMA50'].iloc[-h]\
                            sira +=1
            ...
            #(framew['Trend MACD'].iloc[-1]=='Sell' or framew['Dec_EMA50'].iloc[-1]=='Sell'):
                if option2 == 'EMASUPER':
                   if (frame['Decision Super2'].iloc[-h]=='Sell' or frame['Decision Super'].iloc[-h]=='Sell' or frame['EMA50_cross'].iloc[-h]=='Sell')\
                   ...
                   #and (frame['Close'].iloc[-h]<frame['sup4'].iloc[-h] or frame['Close'].iloc[-h]<frame['sup6'].iloc[-h])\
                            sira +=1
                            expander('emasuper')
                   #elif (frame['Consolidating'].iloc[-1]=='Yes' or frame['Consolidating2'].iloc[-1]=='Yes' or frame['Consolidating3'].iloc[-1]=='Yes')\
                   # and frame['Dec_EMA50'].iloc[-h]=='Sell'\
                   # and frame['EMA50'].iloc[-1]<frame['EMA200'].iloc[-1]\
