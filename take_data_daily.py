...
for name, frame,framew in zip(names,framelist,framelistw): 
    try:
        ...
        #and frame['RISK'].iloc[-1]<=riskvalue:
            ...
            if option1 == 'Buy' and (framew['Dec_EMA50'].iloc[-2]=='Buy' or framew['Dec_EMA20'].iloc[-2]=='Buy'\
            or framew['Close'].iloc[-2]>framew['sup2'].iloc[-2] or framew['Trend MACD'].iloc[-2]=='Buy'):
            ...
            #or framew['Close'].iloc[-1]>framew['sup2'].iloc[-1] or framew['Close'].iloc[-1]>framew['sup4'].iloc[-1])):
                ...
                if option2 == 'EMASUPER':
                   ...
                   #and (frame['Close'].iloc[-h1]>frame['sup6'].iloc[-h1] or frame['Close'].iloc[-h1]>frame['sup4'].iloc[-h1])\
                            sira +=1
                            expander('breakout')
                   elif (framew['Decision Super'].iloc[-2]=='Buy' or framew['Decision Super3'].iloc[-2]=='Buy')\
            ...
            #(framew['Trend MACD'].iloc[-1]=='Sell' or framew['Dec_EMA50'].iloc[-1]=='Sell'):
                if option2 == 'EMASUPER':
                   ...
                   or frame['Decision Super3'].iloc[-h1]=='Sell' or frame['Decision Super'].iloc[-h1]=='Sell')\
                   ...
                   #and (frame['Close'].iloc[-h]<frame['sup4'].iloc[-h] or frame['Close'].iloc[-h]<frame['sup6'].iloc[-h])\
                            sira +=1
                            expander('breakout')
                   elif (framew['Decision Super2'].iloc[-h1]=='Sell'\
                   or framew['Decision Super3'].iloc[-h1]=='Sell' or framew['Decision Super'].iloc[-h1]=='Sell')\
                   and (framew['Dec_EMA50'].iloc[-h1]=='Sell' or framew['Dec_EMA20'].iloc[-h1]=='Sell') :
                   #and (framew['Close'].iloc[-h]<framew['sup4'].iloc[-h] or framew['Close'].iloc[-h]<framew['sup6'].iloc[-h])\
                            sira +=1
                            expander('weak breakout')
                   elif (framew['Decision Super2'].iloc[-h1]=='Sell2' or framew['EMA50_cross'].iloc[-h1]=='Sell2'\
                   or framew['EMA20_cross'].iloc[-h1]=='Sell2')\
                   and (framew['Dec_EMA50'].iloc[-h1]=='Sell' or framew['Dec_EMA20'].iloc[-h1]=='Sell'):
                   #and (framew['Close'].iloc[-h]<framew['sup4'].iloc[-h] or framew['Close'].iloc[-h]<framew['sup6'].iloc[-h])
                            sira +=1
                            expander('week pullback')         
