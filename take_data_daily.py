            ...
            #and (framew['Dec_EMA20'].iloc[-1]=='Buy' or framew['Dec_EMA50'].iloc[-1]=='Buy'):
             ...
             #and (framew['Close'].iloc[-1]>framew['sup4'].iloc[-1] or framew['Close'].iloc[-1]>framew['sup6'].iloc[-1]):
                if option2 == 'EMASUPER':  
                    ...
                    or frame['Decision Super'].iloc[-2]=='Buy3' or frame['Decision Super2'].iloc[-1]=='Buy3' or frame['Decision Super3'].iloc[-1]=='Buy3'\
                    ...
                    or (frame['Dec_EMA20'].iloc[-1]=='Buy' and frame['Close'].iloc[-1]>frame['sup2'].iloc[-1])):
                            sira +=1
                            expander()
