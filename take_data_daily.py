...
def get_figures(frame,r):
    ...
    fig.add_trace(go.Candlestick(x=frame['Date'].tail(r), open=frame['Open'].tail(r-h1+1), high=frame['High'].tail(r-h1+1), low=frame['Low'].tail(r-h1+1), close=frame['Close'].tail(r-h1+1)))
