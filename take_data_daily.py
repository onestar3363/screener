...
for name, frame,framew in zip(names,framelist,framelistw):
    ...
    or (name=='XU030.IS' and frame['Dec_EMA50'].iloc[-1]=='Buy')\
    or (name=='EU50/EUR_Euro Stoxx 50_INDEX_DE' and frame['Dec_EMA50'].iloc[-1]=='Buy')\
    or (name=='^N225' or frame['Dec_EMA50'].iloc[-1]=='Buy'):
        for name, frame,framew in zip(names,framelist,framelistw): 
            try:
