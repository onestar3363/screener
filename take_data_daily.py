    ...
    try:
        if len(frame)>30 and len(framew)>30 and frame['ADX'].iloc[-1]>=adx_value and frame['RISK'].iloc[-1]<=riskvalue :
            ...
            #and framew['sup'].iloc[-1]==1 and framew['Dec_EMA50'].iloc[-1]=='Buy':
                if option2 == 'EMA50':  
                    if frame['EMA50_cross'].iloc[-1]=='Buy' and frame['sup5'].iloc[-1]==1:
                            sira +=1
                            expander()
                if option2 == 'EMA200':  
                    if frame['EMA200_cross'].iloc[-1]=='Buy':
                            ...
                            expander()
                if option2 == 'EMA20':
                    if frame['EMA20_cross'].iloc[-1]=='Buy' and frame['sup5'].iloc[-1]==1:
                            sira +=1
                            expander() 
                if option2 == 'ADX':
            ...
            #and framew['sup'].iloc[-1]==-1 and framew['Dec_EMA50'].iloc[-1]=='Sell':
                if option2 == 'EMA50':  
                    if frame['EMA50_cross'].iloc[-1]=='Sell' and frame['sup5'].iloc[-1]==-1 :
                            sira +=1
                            expander()
                if option2 == 'EMA200':  
                    if frame['EMA200_cross'].iloc[-1]=='Sell' :
                            ...
                            expander()
                if option2 == 'EMA20':
                    if frame['EMA20_cross'].iloc[-1]=='Sell' and frame['sup5'].iloc[-1]==-1 :
                            sira +=1
                            expander() 
                if option2 == 'ADX':
