...
for name, frame,framew in zip(names,framelist,framelistw): 
    try:
        ...
        #and frame['RISK'].iloc[-1]<=riskvalue:
            ...
            if option1 == 'Buy' and (framew['Close'].iloc[-2]>framew['sup2'].iloc[-2] or framew['Trend MACD'].iloc[-2]=='Buy'):
            #or framew['Trend MACD'].iloc[-1]=='Buy'
                ...
                if option2 == 'EMASUPER':
                    ...
                    if (frame['Consolidating'].iloc[-h]=='Yes' and frame['Consolidating2'].iloc[-h]=='Yes' and frame['Consolidating3'].iloc[-h]=='Yes')\
                     and (frame['Trend MACD'].iloc[-1]=='Buy' or frame['Dec_MACD'].iloc[-1]=='Buy' ):
            ...
            if option1 == 'Sell' and (framew['Close'].iloc[-2]<framew['sup2'].iloc[-2] or framew['Trend MACD'].iloc[-2]=='Sell'):
            #(framew['Trend MACD'].iloc[-1]=='Sell' or framew['Dec_EMA50'].iloc[-1]=='Sell'):
                ...
                #            expander('emasuper')
                   if (frame['Consolidating'].iloc[-h]=='Yes' and frame['Consolidating2'].iloc[-h]=='Yes' and frame['Consolidating3'].iloc[-h]=='Yes')\
                    and (frame['Trend MACD'].iloc[-h]=='Sell' or frame['Dec_MACD'].iloc[-h]=='Sell'):
                    #and frame['Close'].iloc[-h]<frame['sup2'].iloc[-h]<frame['sup4'].iloc[-h]<frame['sup6'].iloc[-h]\
                    #and frame['Decision ADX'].iloc[-h]=='Buy':
