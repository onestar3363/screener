...
for name, frame,framew in zip(names,framelist,framelistw): 
    try:
        ...
        #and frame['RISK'].iloc[-1]<=riskvalue:
            ...
            if option1 == 'Buy' and (framew['Trend MACD'].iloc[-1]=='Buy' or framew['Dec_EMA50'].iloc[-1]=='Buy')\
            ...
            #framew['Dec_EMA20'].iloc[-1]=='Buy' or framew['Dec_EMA50'].iloc[-1]=='Buy'
                ...
                if option2 == 'EMASUPER':
                    ...
                    or frame['EMA50_cross'].iloc[-h]=='Buy' or frame['Decision Super3'].iloc[-h]=='Buy')\
                    and frame['Dec_EMA200'].iloc[-h]=='Buy'\
                ...
                if option2 == 'Consolidating':
                    ...
                    and frame['EMA20'].iloc[-1]>frame['EMA50'].iloc[-1] and frame['Dec_EMA50'].iloc[-1]=='Buy'\
                    ...
                    #and (frame['Close'].iloc[-1]<frame['Close'].iloc[-2] or frame['Close'].iloc[-1]<frame['Open'].iloc[-1])\
                            sira +=1
                            expander()                                
            if option1 == 'Sell' and (framew['Trend MACD'].iloc[-1]=='Sell' or framew['Dec_EMA50'].iloc[-1]=='Sell'):
            ...
            #and (framew['Close'].iloc[-1]<framew['sup4'].iloc[-1] or framew['Close'].iloc[-1]<framew['sup6'].iloc[-1])
                if option2 == 'EMASUPER':
                   ...
                   or frame['Decision Super'].iloc[-h]=='Sell' or frame['Decision Super3'].iloc[-h]=='Sell')\
                   and frame['EMA20'].iloc[-h]>frame['EMA50'].iloc[-h]\
                   and (frame['Close'].iloc[-h]<frame['sup4'].iloc[-h] or frame['Close'].iloc[-h]<frame['sup6'].iloc[-h])\
                   and frame['Dec_EMA200'].iloc[-h]=='Sell':
                ...
                if option2 == 'Consolidating':
                    if (frame['Consolidating2'].iloc[-1]=='Yes' and frame['Consolidating3'].iloc[-1]=='Yes')\
                    and frame['EMA20'].iloc[-1]<frame['EMA50'].iloc[-1] and frame['Dec_EMA50'].iloc[-1]=='Sell'\
